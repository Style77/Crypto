...
async def user(ctx,user:discord.Member = None):
    ...
    if not user:
        ...
        userembed.add_field(name="Joined this server at:",value=authorjoinedat)
        userembed.add_field(name="Created account at:", value=authorcreatedat)
        userembed.add_field(name="Playing:", value=author.game)
        userembed.add_field(name="status:", value=author.status)
        userembed.add_field(name="rank colour:", value=author.color)
        userembed.add_field(name="Tag:", value='`'+author.discriminator+'`')
        userembed.add_field(name='Highest rank: ',value=str(author.top_role))
        ...
        userembed.add_field(name="Joined this server at:",value=userjoinedat)
        userembed.add_field(name="Created account at:", value=usercreatedat)
        userembed.add_field(name="Playing:", value=user.game)
        userembed.add_field(name="status:", value=user.status)
        userembed.add_field(name="rank colour:", value=user.color)
        userembed.add_field(name="Tag:", value='`'+user.discriminator+'`')
        userembed.add_field(name='highest rank: ',value=str(user.top_role))
